...
-- local pane_contents = require'telescop-tmux.pane_contents'
...
--         local contents = telescope_utils.get_os_command_output({'tmux', 'capture-pane', '-p', '-t', pane_id, '-S', -num_history_lines})

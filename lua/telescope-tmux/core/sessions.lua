...
---@class TmuxSession
---@fields create_session function
---@fields delete_session function
---@fields rename_session function
---@fields switch_session function
local TmuxSession = {}
TmuxSession.__index = TmuxSession
